...
export default class MicroAccountChart extends Component {
...
static propTypes = {
  ...
  render() {
    ...
    var minY=0;
    var maxY=0;
    Object.keys(self.props.chartData.data).map(date => {

        var value=self.props.chartData.data[date];
        var item={};
        item['date']=date;
        item['value']=value;
        if (!minY || value < minY)
          ...
          <h4>
            ...
            <YAxis
             ...
             <Area type='monotone' dataKey='value' 
              stroke={self.props.chartData.color}
              fill={self.props.chartData.color} />
