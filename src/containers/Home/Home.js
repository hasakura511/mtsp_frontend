  ...
  render() {
    return (
      <div className={classes.Home}>
        <div className={classes.Jumbotron} style={{
          backgroundImage: 'url(' + HomeData.sectionOne.background + '), url(' + HomeData.sectionOne.backgroundFilter + ')'
        }}>
        ...
        >
          ...
          <div className={classes.Container}>
            <img
              src={HomeData.sectionThree.background}
              alt=""
              useMap="mapname"
            />
            <Link to={"/link"}>
